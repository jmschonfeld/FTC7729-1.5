        ...
        switch(step) {
            case 0: //drive to white line
                if (driveODS == null) {
                    ...
                    if (driveODS.runToTarget(0.8, 0.01, DriveDirection.DRIVE_FORWARD)) {
                        driveODS = null;
                        step++;
                    }
                }
            ...
            case 1: //drive past white line
                if (driveTime == null) {
                    ...
                    if (driveTime.runToTarget(0.25, 0.1, DriveDirection.DRIVE_FORWARD)) {
                        driveTime = null;
                        step++;
                    }
                }
            ...
            case 2: //turn to align with white line
                if (driveODS == null) {
                    ...
                    if (driveODS.runToTarget(0.25, 0.01, DriveDirection.SPIN_RIGHT)) {
                        driveODS = null;
                        step++;
                    }
                }
            ...
            case 3: //spin towards the correct button
                if (driveTime == null) {
                    ...
                    if (driveTime.runToTarget(0.3, 0.3, side == 0 ? DriveDirection.SPIN_RIGHT : DriveDirection.SPIN_LEFT)) {
                        driveTime = null;
                        step++;
                    }
                }
            ...
            case 4: //move forward towards button
                if (driveTime == null) {
                    ...
                    if (driveTime.runToTarget(0.5, 2, DriveDirection.DRIVE_FORWARD)) {
                        driveTime = null;
                        step++;
                    }
                }
            ...
            case 5: //move backwards away button
                if (driveTime == null) {
                    ...
                    if (driveTime.runToTarget(0.25, 2, DriveDirection.DRIVE_BACKWARD)) {
                        driveTime = null;
                        step++;
                    }
                }
            ...
            case 6: //spin to align with white line
                if (driveTime == null) {
                    ...
                    if (driveTime.runToTarget(0.3, 0.3, side == 1 ? DriveDirection.SPIN_RIGHT : DriveDirection.SPIN_LEFT)) {
                        driveTime = null;
                        step++;
                    }
                }
